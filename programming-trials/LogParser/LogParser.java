...
class LogParserMain
{
	public static void main(String args[]) throws IOException, FileNotFoundException, ParserConfigurationException
	{
		...
		File file = new File("/home/adildsw/programming-trials/LogParser/log-examples/windows-ci.txt");
		...
		LogParser parse = new LogParser(log);
		System.out.println("Workspace: " + parse.getWorkspaceName());

		PipelineXMLBuilder xml = new PipelineXMLBuilder(log, "test-job", "1","test-job-1", "test-job-tag", "12ms", "21/7/18");
		xml.publishXML();
	}
}
